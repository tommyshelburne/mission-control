  ...
  return (
    <>
      ...
      <div className="flex h-full overflow-hidden">
        {/* Left panel */}
        <div className="w-[240px] flex-shrink-0 border-r border-[var(--border)] flex flex-col overflow-hidden bg-[var(--bg-surface)]">
          ...
          <div className="flex-1 overflow-y-auto">
            {listLoading ? (
              ...
              groups.map((group) => (
                <div key={group.label}>
                  <div className="uppercase font-medium" style={{ fontSize: 10, letterSpacing: '0.08em', color: 'var(--text-muted)', padding: '0 16px', marginTop: 20 }}>
                    {group.label}
                  </div>
                  {group.items.map((entry) => {
                    ...
                    return (
                      <button
                        ...
                        className="w-full flex items-center justify-between cursor-pointer hover:bg-[var(--bg-hover)]"
                      ...
                      >
                        <span className="text-12 text-[var(--text-primary)]">
